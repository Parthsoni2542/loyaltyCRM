...
import UsedApptDetailComponent from '../components/UsedApptDetailComponent';
...
const UsedSessionDetailScreen = () => {
  ...
  return (
    <UsedApptDetailComponent
    currentService={route.params?.currentService}
...
export default UsedSessionDetailScreen;
